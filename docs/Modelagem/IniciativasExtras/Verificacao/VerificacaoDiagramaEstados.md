...
| T02  | Cada transição é rotulada com o evento que a dispara (trigger), opcionalmente seguido por uma condição de guarda e uma ação/efeito? | Formato: `evento [condição_guarda] / ação_efeito`.                                                                                                      | [IBM - Diagramas de Máquina de Estados](https://www.ibm.com/docs/pt-br/engineering-lifecycle-management-suite/systems-design-rhapsody/6.0.6?topic=diagrams-statechart) |
